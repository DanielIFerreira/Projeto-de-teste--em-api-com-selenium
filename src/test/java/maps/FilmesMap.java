...
public class FilmesMap {
    ...
    public static void initCategorias(){
        ...
        categoria1.put("tipo", "AÃ§Ã£o");
        categoria2.put("tipo", "ComÃ©dia");
    ...
    public static void initFilmes(){
        ...
        filme.put("descricao", "Um alerta vermelho da Interpol é emitido e o agente do FBI John Hartley" +
                ...
                " a se aliar ao maior ladrão de arte da história.");
        filme.put("duracao", 1.32);
        filme.put("categoria",listCategoria);
        filme.put("platafromas",listPlataforma);
